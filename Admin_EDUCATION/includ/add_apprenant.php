...
<nav>
    ...
    <?php
        if(isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO apprenant (firstname, lastname, email , role , password, img) VALUES (:firstname, :lastname, :email , :role, :password, :img)";
...
<div class="container mt-5">
		<div class="row">
			<div class="col-md-12">
				<h2 class="mb-4">Ajouter un apprenant</h2>

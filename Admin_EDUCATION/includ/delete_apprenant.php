...
<nav>
    ...
    <?php
        if(isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO apprenant (firstname, lastname, email, password, img) VALUES (:firstname, :lastname, :email, :password, :img)";
...
<div class="container mt-5">
		<div class="row">
			<div class="col-md-12">
				<h2 class="mb-4">Supprimer un apprenant</h2>
				<?php
				...
				?>
				<p>Voulez-vous vraiment supprimer l'apprenant <?php echo $result['firstname'] . ' ' . $result['lastname']; ?> ?</p>
				<form action="delete.php?id=<?php echo $result['id_apprenant']; ?>" method="post">

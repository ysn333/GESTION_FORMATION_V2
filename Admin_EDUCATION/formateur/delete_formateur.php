...
<div class="container mt-5">
		<div class="row">
			<div class="col-md-12">
				<h2 class="mb-4">Supprimer un Formateur</h2>
				<?php
					...
					if (!$result) {
						echo "<p>Cet formateur n'existe pas.</p>";
					} else {
				?>
				<p>Voulez-vous vraiment supprimer l'formateur <?php echo $result['firstname'] . ' ' . $result['lastname']; ?> ?</p>
				<form action="delete.php?id=<?php echo $result['id_formateur']; ?>" method="post">
